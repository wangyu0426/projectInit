// !!!!!!!!!!!!!! MODIFIED VERSION !!!!!!!!!!!!!!!!!
// 1. Modified Template Url from "ngTagsInput/*.html" to "app/lib/ui/ngTagsInput/*.html" to make it compatible with Raygun injection
// 2. There is a JS vulnerability in tiAutocompleteMatch. Changed "return $sce.trustAsHtml(text);" to "return text;".
// Check these points before upgrading this library
// !!!!!!!!!!!!!! MODIFIED VERSION !!!!!!!!!!!!!!!!!
/*!
 * ngTagsInput v3.1.1
...
tagsInput.directive('tagsInput', ["$timeout", "$document", "$window", "$q", "tagsInputConfig", "tiUtil", function($timeout, $document, $window, $q, tagsInputConfig, tiUtil) {
    ...
    return {
        ...
        replace: false,
        transclude: true,
        templateUrl: 'app/lib/ui/ngTagsInput/tags-input.html',
        controller: ["$scope", "$attrs", "$element", function($scope, $attrs, $element) {
            $scope.events = tiUtil.simplePubSub();

            tagsInputConfig.load('tagsInput', $scope, $attrs, {
                template: [String, 'app/lib/ui/ngTagsInput/tag-item.html'],
...
tagsInput.directive('autoComplete', ["$document", "$timeout", "$sce", "$q", "tagsInputConfig", "tiUtil", function($document, $timeout, $sce, $q, tagsInputConfig, tiUtil) {
    ...
    return {
        ...
        templateUrl: 'app/lib/ui/ngTagsInput/auto-complete.html',
        controller: ["$scope", "$element", "$attrs", function($scope, $element, $attrs) {
            $scope.events = tiUtil.simplePubSub();

            tagsInputConfig.load('autoComplete', $scope, $attrs, {
                template: [String, 'app/lib/ui/ngTagsInput/auto-complete-match.html'],
...
tagsInput.run(["$templateCache", function($templateCache) {
    $templateCache.put('app/lib/ui/ngTagsInput/tags-input.html',
