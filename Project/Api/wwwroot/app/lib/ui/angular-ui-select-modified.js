 ...
 * Version: 0.18.0 - 2016-06-28T03:29:48.893Z
 * License: MIT
 */
  ...
  return {
    ...
    controller: ['$scope','$timeout', function($scope, $timeout){
      ...
      ctrl.refreshComponent = function(){
        ...
        //console.log('- modified - : breaks when executing undefined function');
        //console.log(typeof $select.refreshItems);
        if(!angular.isUndefined($select.refreshItems)) { $select.refreshItems(); }
        $select.sizeSearchInput();
      };
