 ...
 JustGage = function(config) {
  ...
  obj.config =
  {
    ...
    maxLabelMinFontSize : obj.kvLookup('maxLabelMinFontSize', config, dataset, 10),
      ...
      minLabelTxt: obj.kvLookup('minLabelTxt', config, dataset, null),
      maxLabelTxt: obj.kvLookup('maxLabelTxt', config, dataset, null),
  ...
  if (obj.config.donut === true) {
    ...
    // value
    valueFontSize = ((widgetH / 7) > 16) ? (widgetH / 6) : 18; //modified by jeremiah for slightly smaller text - originally it was ((widgetH / 6.4) > 16) ? (widgetH / 5.4) : 18;
    valueX = dx + widgetW / 2;
    if(obj.config.label !== '') {
  ...
  // min
  if (obj.config.minLabelTxt !== null) {
      obj.txtMinimum = obj.config.minLabelTxt;
  } else {
  ...
  // max
 if (obj.config.maxLabelTxt !== null) {
         obj.txtMaximum = obj.config.maxLabelTxt;
 } else {
...
JustGage.prototype.refresh = function(val, max) {
  ...
  if(max !== null) {
    ...
    obj.txtMax.attr({"text" : obj.txtMaximum + obj.config.symbol});
    setDy(obj.txtMax, obj.params.maxFontSize, obj.params.maxY);
  }
