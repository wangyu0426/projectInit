(function() {
	"use strict";
	angular.module("app").directive("mtkPassword", function() {
		return {
			restrict: "E",
			replace: true,
			template: '<input ng-attr="{id: elId,name: elId}" placeholder="{{mtkInputPlaceholder}}" class="form-control" type="password" ng-model="model"/>',
			scope: {
				model: "=model",
				elId:"@id",
